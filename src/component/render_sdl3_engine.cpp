#include "render_sdl3_engine.hpp"
#include <iostream>
...
void RenderEngineSDL3::setup()
    ...
    void RenderEngineSDL3::setScene(core::SceneRenderable& scene)
    {
    ...
    core::SceneRenderable* RenderEngineSDL3::getCurrentScene() const
    {
        return currentScene;
    }
